...
function generatePrTeams(devTeams, prTeamSize, minOutsiders) {
  ...
  if (assignmentsAttempts === 10) {
    return 'Infinite loop condition. Please file an issue with entire input at ' +
        'https://github.com/ianmstew/pr-teams/issues, and in the meantime attempt using different arguments.';
  }
